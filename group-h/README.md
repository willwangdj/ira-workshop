...
# 鍛藉悕瑙勮寖锛?
# feature/GROUP-H-{缂栧彿}-{妯″潡鍚峿
# 绀轰緥锛歠eature/GROUP-H-01-m1
...
绀轰緥锛?
GROUP-H-01: 瀹屾垚 M1 妯″潡 Spec 鏂囨。
GROUP-H-03: 瀹炵幇澶氭簮鏁版嵁闆嗘垚
GROUP-H-05: 娣诲姞鐭ヨ瘑搴撻棶绛斿姛鑳?
```
...
- Spec 鏂囨。璺緞锛歚GROUP-H/01/docs/`
- 浠ｇ爜璺緞锛歚GROUP-H/01/backend/`
...
- 鉁?鍙互缂栬緫锛歚GROUP-H/01/`, `GROUP-H/02/`, ...
